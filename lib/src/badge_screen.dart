        ...
        children: [
              ...
              children: [
                    ...
                    children: [
                        ...
                        icon: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                blurRadius: 12,
                                color: const Color(0xff8B55F6).withValues(alpha: .15),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            const Text('Koleksi Badge 🏆',
                              style: TextStyle(
                                fontSize: 22, fontWeight: FontWeight.w900,
                                color: Color(0xff2F2D72),
                              ),
                            ),
                            Text('$unlocked / ${badges.length} Badge Terbuka',
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Icon(Icons.star_rounded, color: Color(0xffFFD84D), size: 20),
                ...
                Padding(
                  ...
                  child: _OverallBadgeProgress(
                    unlocked: unlocked, total: badges.length,
                  ),
                ),
                ...
                Expanded(
                  child: GridView.builder(
                    padding: EdgeInsets.fromLTRB(
                      tablet ? 24 : 14, 4, tablet ? 24 : 14, 100,
                    ),
          ...
          Align(
            ...
            child: ConfettiWidget(
              ...
              colors: const [
                Color(0xffFFD700), Color(0xff8B55F6),
                Color(0xffFF7CBD), Color(0xff42A5F5),
                Color(0xff66BB6A), Color(0xffFF9800),
              ],
            ),
          ),
        ],
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Progress Koleksi Badge',
                  style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: unlocked ? badge.glowColor.withValues(alpha: .6) : const Color(0xffE0E0E0),
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Text(rarityLabel(badge.rarity),
                      style: TextStyle(
                        ...
                        ...List.generate(6, (i) {
                          ...
                          return Positioned(
                            ...
                            child: Icon(
                              ...
                              size: 8,
                              color: badge.glowColor.withValues(alpha: .6),
                            ).animate(
                      ...
                      if (!unlocked)
                        Positioned(
                          ...
                          child: Container(
                            width: 26, height: 26,
                            decoration: BoxDecoration(
                              color: const Color(0xff7A7E9B).withValues(alpha: .85),
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.white, width: 2),
                            ),
                ...
                Text(badge.title,
                  ...
                  style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.w900,
                    color: unlocked ? const Color(0xff2F2D72) : const Color(0xff9E9E9E),
                  ),
                ),
                ...
                Text(badge.description,
                  ...
                  style: TextStyle(
                    ...
                    color: unlocked ? const Color(0xff7A7E9B) : const Color(0xffBDBDBD),
                    height: 1.2,
                  ),
                ),
                ...
                ClipRRect(
                  ...
                  child: TweenAnimationBuilder<double>(
                    ...
                    builder: (_, v, child) => LinearProgressIndicator(
                      ...
                      color: unlocked ? badge.glowColor : const Color(0xffBDBDBD),
                    ),
                  ),
                ),
                const SizedBox(height: 4),
                Text(unlocked ? '✅ Terbuka!' : '$cur / ${badge.requiredProgress}%',
                  style: TextStyle(
                    fontSize: 10, fontWeight: FontWeight.w800,
                    color: unlocked ? const Color(0xff4CAF50) : const Color(0xff9E9E9E),
                  ),
                ),
              ],
            ),
    ...
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: badge.glowColor.withValues(alpha: .4), width: 3),
          boxShadow: [
            BoxShadow(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text('Kamu mendapatkan Badge baru!',
              style: TextStyle(
            ...
            Container(
              ...
              child: Image.asset(badge.assetUnlocked, fit: BoxFit.contain),
            ).animate()
             .scale(begin: const Offset(.3, .3), duration: 600.ms, curve: Curves.elasticOut),
            ...
            Text(badge.description,
              ...
              style: const TextStyle(
                ...
                color: Color(0xff7A7E9B), height: 1.3,
              ),
            ),
        ...
        begin: const Offset(.8, .8), duration: 400.ms,
